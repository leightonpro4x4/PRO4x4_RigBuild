...
(function(){
  ...
  let c={};loadBrowser('data-ranger.js',c);const d=c.RANGER_DATA;assert(d.accessories.length>=24,'Push 03 Ranger baseline must retain its 24 verified records');assert.ok(['0.26.2','0.26.3','0.26.4'].includes(d.schemaVersion));
