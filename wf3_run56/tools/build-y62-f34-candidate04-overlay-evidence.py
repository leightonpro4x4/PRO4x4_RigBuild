...
OUT=ROOT/'assets/y62-canonical-candidates/Y62-F34-V1-candidate-04-overlay-evidence-v02.png'
META=ROOT/'assets/y62-canonical-candidates/Y62-F34-V1-candidate-04-overlay-evidence-v02.json'
...
d.text((30,64),'Candidate 04 · exact-checksum machine precheck only · NOT production approval',font=F2,fill=(255,190,70))
...
panels=[('A · OWNER SOURCE REGISTERED',registered_rgb),('B · CANDIDATE 04 / ALPHA',comp),('C · 50/50 GEOMETRY OVERLAY',blend),('D · ALPHA EDGE + RANSAC INLIERS',edge_panel)]
...
meta={
 ...
 'evidenceId':'Y62-F34-V1-OVERLAY-EVIDENCE-02',
 ...
 'artifact':{'file':'assets/y62-canonical-candidates/Y62-F34-V1-candidate-04-overlay-evidence-v02.png'}
}
