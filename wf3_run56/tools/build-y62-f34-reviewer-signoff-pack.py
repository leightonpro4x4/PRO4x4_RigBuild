...
OVERLAY_META=ROOT/'assets/y62-canonical-candidates/Y62-F34-V1-overlay-evidence-v01.json'
OUT=ROOT/'assets/y62-canonical-candidates/Y62-F34-V1-reviewer-signoff-pack-v01.png'
META=ROOT/'assets/y62-canonical-candidates/Y62-F34-V1-reviewer-signoff-pack-v01.json'
REFS=[
...
d.text((36,76),'Candidate 03 · owner-reference-backed · IDENTIFIED REVIEWER REQUIRED · NOT PRODUCTION APPROVAL',font=Fsub,fill=(255,188,66))

# Large candidate / registered source panels.
for title,img,x in [('A · CANDIDATE 03 / ALPHA',comp_im,36),('B · PRIMARY OWNER SOURCE REGISTERED',reg_im,1068)]:
...
for i,(name,box) in enumerate(crops):
    ...
    d.text((x,cy+254),'registered owner source',font=Fs,fill=(165,175,180)); d.text((x+326,cy+254),'Candidate 03',font=Fs,fill=(165,175,180))
...
meta={
 'schemaVersion':'0.26.8',
 'packetId':'Y62-F34-V1-REVIEWER-SIGNOFF-01',
