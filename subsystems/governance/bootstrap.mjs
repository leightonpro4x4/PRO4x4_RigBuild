...
export function bootstrapGovernance(root){
  ...
  const registry=new GovernanceRegistry({baseline,filename:path.join(root,'.runtime/alpha94.sqlite'),readBinary:s=>archives[s.branch]?.get(s.path)});
