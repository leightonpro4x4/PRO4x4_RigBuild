(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.Y62_READINESS_PLAN=api;})(typeof globalThis!=='undefined'?globalThis:this,function(){
  ...
  const canonicalMasters={front34:{briefId:'Y62-F34-V1',state:'transparent-isolation-review',latestCandidateId:'Y62-F34-V1-CANDIDATE-02',governanceState:'master-draft',productionEligible:false,passed:['owner identity','owner stance','factory Warrior rolling stock','alpha channel present'],blocked:['clean isolation','edge quality','neutral reconstruction','locked overlay acceptance','production-binary rights','reviewer approval']},side:{briefId:'Y62-SIDE-V1',state:'queued',productionEligible:false,blocked:['owner pack lacks clean square-on raw side source']},rear34:{briefId:'Y62-R34-V1',state:'queued',productionEligible:false,blocked:['F34 canonical family must be accepted first']}};
  ...
  return {schemaVersion:'0.26.5',vehicleId,views,paints,wheelTyres,canonicalMasters,thresholds,expectedSlots};
});
