(function(){
  ...
  class HttpAdapter{
    ...
    async getQuoteLineage(reference){return this.request(`/staff/quotes/${encodeURIComponent(reference)}/lineage`)}
    ...
    async assessRenderReadiness(vehicleId){return this.request('/staff/render-readiness/assess',{method:'POST',body:JSON.stringify({vehicleId})})}
    ...
    async attestReferenceProvenance(assetId){return this.request(`/staff/render-assets/${encodeURIComponent(assetId)}/provenance-attestation`,{method:'POST',body:'{}'})}
    async submitReferenceReviewDecision(assetId,payload){return this.request(`/staff/render-assets/${encodeURIComponent(assetId)}/reference-review-decision`,{method:'POST',body:JSON.stringify(payload||{})})}
    async refreshCanonicalGovernanceDossier(assetId){return this.request(`/staff/render-assets/${encodeURIComponent(assetId)}/governance-dossier`,{method:'POST',body:'{}'})}
    async canonicalReviewWorkflow(assetId,action='refresh',payload={}){return this.request(`/staff/render-assets/${encodeURIComponent(assetId)}/review-workflow`,{method:'POST',body:JSON.stringify({action,...(payload||{})})})}
    async submitCanonicalReviewDecision(assetId,payload){return this.request(`/staff/render-assets/${encodeURIComponent(assetId)}/review-decision`,{method:'POST',body:JSON.stringify(payload||{})})}
    async submitCanonicalSourceGapResolution(assetId,payload){return this.request(`/staff/render-assets/${encodeURIComponent(assetId)}/source-gap-resolution`,{method:'POST',body:JSON.stringify(payload||{})})}
    ...
    async getAuditIntegrity(){return this.request('/staff/audit/integrity')}
