...
(async()=>{
 ...
 try{
  ...
  asset=out.asset;asset.provenance={...asset.provenance,sourceType:'pro4x4-original',licenceStatus:'owned',licenceNote:'Alpha 16 test-owned transparent base layer.'};asset.cameraGeometry={...asset.cameraGeometry,matched:true,notes:'Manual overlay verified in Alpha 16 test.'};asset.status='production-ready';asset.governance={...(asset.governance||{}),state:'master-approved',reviewedBy:'Alpha 16',reviewedAt:new Date().toISOString()};asset.approval={...asset.approval,state:'approved-production',approvedBy:'Alpha 16',approvedAt:new Date().toISOString()};
