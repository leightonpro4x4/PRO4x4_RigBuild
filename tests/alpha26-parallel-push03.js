...
(function(){
  ...
  let c={};loadBrowser('data-ranger.js',c);const d=c.RANGER_DATA;assert(d.accessories.length>=24,'Push 03 Ranger baseline must retain its 24 verified records');assert.ok(['0.26.2','0.26.3','0.26.4','0.26.5','0.26.6','0.26.7','0.26.8','0.26.9','0.26.10','0.26.11','0.26.12','0.26.13','0.26.15','0.26.16','0.26.17','0.26.18','0.26.22'].includes(d.schemaVersion));
  ...
  c={};loadBrowser('ranger-source-evidence.js',c);assert(c.RANGER_SOURCE_EVIDENCE.sources.length>=5,'Push 03 source-evidence baseline must be retained');assert.ok(c.RANGER_SOURCE_EVIDENCE.sources.every(x=>x.sourceType==='manufacturer'||x.sourceType==='manufacturer-parent-plus-current-dealer-fitment-and-product-spec'||x.sourceType==='manufacturer-product-support + Australian-retail-price + manufacturer-vehicle-fitment'));
