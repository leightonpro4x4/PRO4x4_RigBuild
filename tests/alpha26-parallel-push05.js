...
(function(){
 let c={};load('data-ranger.js',c);const d=c.RANGER_DATA;assert.ok(['0.26.4','0.26.5','0.26.6','0.26.7','0.26.8','0.26.9','0.26.10','0.26.11','0.26.12','0.26.13','0.26.15','0.26.16','0.26.17','0.26.18','0.26.22'].includes(d.schemaVersion));assert(d.accessories.length>=28);
